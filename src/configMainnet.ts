...
// const provider: JsonRpcProvider = await getProvider(ChainId.mainnet);
...
const POOLS = {
  activePools: [1001, 1004, 1005, 1009, 1010, 1012, 1013, 1014, 1015, 1017, 1018, 10001, 10003, 10005, 10009, 10010],
  //activePools : [],
...
const TOKENS = {
  ...
  oneuni: {
    ...
    aux_strategy: ['0x55922Fa5084f9367B73FC0df9163B089D8Ac4CB7', '0x0b10e483aac4340256772754d23131b6e0dc31ea'],
